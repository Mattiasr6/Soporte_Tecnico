...
namespace SoporteTecnico.API.Migrations
{
    ...
    [Migration("20260828080203_V2_JerarquiaAreas")]
    partial class V2_JerarquiaAreas
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SoporteTecnico.API.Models.Area", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("GrupoPadreId", "GrupoId", "Nombre")
                        .IsUnique();
            ...
            modelBuilder.Entity("SoporteTecnico.API.Models.Grupo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("GrupoPadreId", "Nombre")
                        .IsUnique();

                    b.ToTable("Grupos", (string)null);
                });

            modelBuilder.Entity("SoporteTecnico.API.Models.GrupoPadre", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("GruposPadres", (string)null);
            ...
            modelBuilder.Entity("SoporteTecnico.API.Models.Area", b =>
                {
                    b.HasOne("SoporteTecnico.API.Models.Grupo", "Grupo")
                        .WithMany("Areas")
                        .HasForeignKey("GrupoId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("SoporteTecnico.API.Models.GrupoPadre", "GrupoPadre")
                        .WithMany("Areas")
            ...
            modelBuilder.Entity("SoporteTecnico.API.Models.Atencion", b =>
                {
                    b.HasOne("SoporteTecnico.API.Models.Area", "Area")
                        .WithMany()
